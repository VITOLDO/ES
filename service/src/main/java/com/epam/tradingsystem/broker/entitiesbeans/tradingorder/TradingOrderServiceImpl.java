...
public class TradingOrderServiceImpl implements TradingOrderService {
	...
	@Autowired
    private TradingOrderDAO tradingOrderDAO;

    @Override
    public TradingOrder findTradingOrderById(long id) {
        return tradingOrderDAO.findById(id);
    }

    @Override
    public List<TradingOrder> findAllTradingOrders() {
        return tradingOrderDAO.findAll();
    }
